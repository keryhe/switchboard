// Phase 5 D30 client probe (JS, @microsoft/signalr 10.0.0). Implements exactly the scenario in
// tests/Keryhe.Switchboard.CompatibilityTests/ClientProbeContract.md — kept byte-for-byte parallel
// with tests/clients/js/v8/probe.mjs so a JS-version-specific defect (the kind finding 1 found for
